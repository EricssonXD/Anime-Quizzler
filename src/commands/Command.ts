...
import { ANIME_QUIZ_COMMANDS } from "./AnimeQuizCommand";
...
export class CommandManager {
  private static readonly COMMANDS: Command[] = [...COMMANDS, ...PLAY_COMMANDS, ...MUSIC_CONTROL_COMMANDS, ...PLAYLIST_CONTROL_COMMANDS, ...ANIME_QUIZ_COMMANDS];
